...
const Filter = () => {
    ...
    const toggleFilter = (filter: string) => {
        setSelectedFilters((prev) =>
            prev.includes(filter)
                ? prev.filter((f) => f !== filter) // Elimina si ya está
                : [...prev, filter] // Agrega si no está
        );
    };
    ...
    return (
        <div>
            ...
            <section className="max-w-7xl mx-auto px-1 sm:px-6 lg:px-8 md:mt-24">
                <div className="flex flex-col items-baseline justify-between border-b border-gray-200 pb-6">
                    <FoodListHeader />
